...
class r_SDL
{
    public:
        ...
        static SDL_Texture* RenderUnicode( uint16_t text[], TTF_Font*  font, SDL_Renderer* renderer, SDL_Color color = {0xFF,0xFF,0xFF,0xFF}, SDL_Texture* texture = NULL); // renders a unicode symbol
