...
class r_SDL
{
    public:
        ...
        static SDL_Texture* RenderUnicode( const uint16_t symbols[], TTF_Font* font, SDL_Renderer* renderer, Uint32 format, SDL_Texture* texture = NULL, SDL_Color color = {0xFF,0xFF,0xFF,0xFF}, SDL_Rect charDimensions = {0,0,0,0}); // renders a unicode symbol
